      ...
      {small ? (
        <div className="dropdown absolute top-6 left-4">
          ...
          <div className="dropdown-content">
            ...
            <a onClick={() => handleItemClick('investor-magt')}>Investor Mgt</a>
        ...
        <div className="bg-buttonBlue text-white w-fit min-h-screen flex flex-col p-5">
          ...
          <ul className="flex flex-col gap-6 text-sm ml-1 mt-24 cursor-pointer w-full">
            <li
              className={`flex items-center gap-2 pl-2 ${selected === 'investor' ? 'border-l-4 border-white' : ''}`}
              onClick={() => handleItemClick('dashboard')}
            >
              <i className="bx bxs-dashboard"></i> Dashboard
            </li>
            <li
              className={`flex items-center gap-2 pl-2 ${selected === 'investor-magt' ? 'border-l-4 border-white' : ''}`}
              onClick={() => handleItemClick('investor-magt')}
            >
